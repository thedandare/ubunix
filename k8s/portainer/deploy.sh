...
echo ""
echo "    Portainer only accepts the initial admin password within 5 min of pod start."
echo "    If you see 'Administrator initialization timeout', restart it and log in right away:"
echo "      ssh $SSH_HOST 'microk8s kubectl rollout restart deploy/portainer -n $NAMESPACE'"
